...
<section>
    ...
    <div class="container" id="destaque-produtos-solo-container">

        <div id="destaque-produtos-solo">
            ...
            <div class="item">
                ...
                <div class="col-sm-6 col-descricao">
                    ...
                    <div class="box-valor">
                        ...
                        <div class="text-parcelas text-arial-cinza">ou em até<?= $produto['parcelas'] ?>x de R$<?= $produto['parcela'] ?>
                        </div>
                        <div class="text-total text-arial-cinza">total a prazo R$
                            <?= $produto['total'] ?>
                        </div>
                    </div>

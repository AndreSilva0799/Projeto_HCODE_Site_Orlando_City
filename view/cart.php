...
<section ng-controller="cart-controller">
	...
	<div class="container">
		...
		<table id="cart-products" class="table table-bordered">
			<thead> <!-- thead titulo das colunas (cabeçalho)
					tr = linha
					tbody corpo da tabela
					tr com ng-repeat é para repetir caso tenha mais de 1 produto repete a linha
					td coluna, está relacionada ao titulo então primeiro td é oprimeiro th 
					th colspan="2" indica que essa coluna produto vai ocupar duas colunas que seria img e o nome do produto
				&nbsp isso significa esaço no html iremos usar para excluir o produto -->
				<tr>
			...
			<tbody>
				<tr ng-repeat="produto in produtos">
					<td class="text-center"><img ng-src="../img/produtos/{{produto.foto_principal}}"></td>
					<td>{{produto.nome_prod_long}}</td>
					<td class="col-xs-2">
						<div class="input-group">
							<span class="input-group-btn">
								<button class="btn text-roxo" ng-click="removeQtd(produto)" type="button"><i
										class="fa fa-chevron-down"></i></button>
							</span>
							<input type="text" class="form-control" ng-model="produto.qtd_car">
							<span class="input-group-btn">
								<button class="btn text-roxo" ng-click="addQtd(produto)" type="button"><i
					...
					<td class="text-center"><button ng-click="removeAll(produto)" class="btn text-roxo" type="button"><i

<?php include_once("header.php"); // inclua apenas uma vez o arquivo header.php ?>
        ...
        <div id="destaque-produtos">
            ...
            <div class="item" ng-repeat="produto in produtos">
                ...
                <div class="col-md-6 col-imagem">
                    <a href="http://localhost/projeto01/Site_Olando_City/view/produto-{{produto.id_prod}}">
                        <img ng-src="../img/produtos/{{produto.foto_principal}}" alt="{{produto.nome_prod_longo}}">
                    </a>
                </div>
                ...
                <div class="col-sm-6 col-descricao">
                    ...
                    <div class="box-valor">
                        ...
                        <div class="text-parcelas text-arial.cinza">ou até em {{produto.parcelas}}x de R$
                            {{produto.parcela}}</div>
            ...
            <div class="col-md-3" ng-repeat="produto in buscados">
                <div class="box-produto-info">
                    <a href="http://localhost/projeto01/Site_Olando_City/view/produto-{{produto.id_prod}}">
                        ...
                        <div class="text-parcelado text-arial.cinza">{{produto.parcelas}}x de R$ {{produto.parcela}} sem
                            juros</div>
                    </a>
                </div>
            </div>

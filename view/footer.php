<footer>
        <div class=" row row-cinza-claro">
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-md-2 text-center hidden-xs"> <!--text - center para centralizar, hidden-xs para esconder -->
                        ...
                        <div class="row row-cols">
                            ...
                            <div class="col-md-4 col-popular-post hidden-xs">
                                ...
                                <ul class="list-unstyled">
                                    <!--uma lista, a class é para usar o bootstrap para tirar as bolinhas da lista -->
                                    <li>
                                        <h5>Neque porro quisquan est,quister.</h5>
                            ...
                            <div class="col-md-4 col-get-in-touch">
                                ...
                                <div class="roow-fluid visible-xs">
                                    <div class="col-xs-6">
    ...
    <!--<script src="../lib/jquery/jquery.min.js"></script>
     <script src="../lib/OwlCarousel3/dist/owl.carousel.min.js"></script> -->
    <script src="https://cdn.es.gov.br/scripts/jquery/1.11.2/jquery-1.11.2.min.js"></script>
    <script src="https://cdn.es.gov.br/scripts/jquery/jquery-owl-carousel/2.0.0/js/owl.carousel.min.js"></script>
